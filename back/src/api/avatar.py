...
from database.repository import AvatarRepository, UserRepository, delete_file
...
from utils.file_utils import validate_image_file, generate_unique_filename, save_upload_file
